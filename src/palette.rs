...
impl Command {
    ...
    pub const fn title(self) -> &'static str {
        match self {
            ...
            Self::SplitRight => "Split Right",
            Self::SplitDown => "Split Down",
            Self::NextPane => "Go to Next Split",
            Self::ClosePane => "Close Split",
            Self::OnlyPane => "Close Other Splits",
            Self::EqualizePanes => "Even Out Splits",
    ...
    pub const fn hint(self) -> &'static str {
        match self {
            ...
            Self::CloseTab => "Ctrl W D",
            Self::SplitRight => "Ctrl W V",
            Self::SplitDown => "Ctrl W S",
            Self::NextPane => "Ctrl W W",
            Self::ClosePane => "Ctrl W C",
            Self::OnlyPane => "Ctrl W O",
            Self::EqualizePanes => "Ctrl W =",
